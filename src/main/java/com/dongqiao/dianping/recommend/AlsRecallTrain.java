...
public class AlsRecallTrain implements Serializable {
    ...
    public static void main(String[] args) throws IOException {
        ...
        JavaRDD<String> csvFile = spark.read().textFile("ml_data/behavior.csv").toJavaRDD();
        ...
        alsModel.save("ml_data/alsmodel");

//        AlsRecallPredict predict = new AlsRecallPredict();
//        predict.alsPredict(alsModel, rating);
    }
