...
function setPage(currPage,totalCount,urlHeader) //currPage 当前页数; totalCount 总数量
{
	 ...
	 var sTemp2 = "<div class=\"page-btn-container inline-block\"><input type=\"text\" id=\"goPageNo\" value=\""+currPage+"\" class=\"search-area-for-page border text-align-center\" /><a class=\"btn inline-block border-btn page-btn\" type=\"button\" href=\"Javascript:toPage('"+urlHeader+"');\");\">redirect</a></div>"
	 if (totalCount==0)
	 {
		 sTemp = "none";
	 ...
	 {
		 sTemp = "<a href='#' class='disabled'>prev</a>"+ sTemp1 +"<a href='#' class='disabled'>next</a>";
		 container.innerHTML = sTemp +"  "+ sTemp2 ;
	 }
	 else if (iPageCount==currPage)
	 {
		 sTemp = "<a href='#'>prev</a>"+ sTemp1 +"<a href='#' class='disabled'>next</a>";
		 container.innerHTML = sTemp +"  "+ sTemp2 ;
	 }
	 else if (currPage==1)
	 {
		 sTemp = "<a href='#' class='disabled'>prev</a>"+ sTemp1 +"<a href='#'>next</a>";
		 container.innerHTML = sTemp +"  "+ sTemp2 ;
	 }
	 else
	 {
		 sTemp = " <a href='#'>prev</a>"+ sTemp1 +"<a href='#'>next</a>";
		 container.innerHTML = sTemp +"  "+ sTemp2 ;
	 }
